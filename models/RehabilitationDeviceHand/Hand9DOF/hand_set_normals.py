...
class AddNormalsSDF:
  def __init__(self, input_file, output_file) -> None:
    ...
    self.normals = {
      'ThumbTMC_FE_joint': '0.028 0.407 -0.913',
      'ThumbTMC_AA_joint': '-0.496 0.731 -0.468',
      'ThumbMCP_joint': '0.028 0.407 -0.913',
      'ThumbIP_joint': '0.028 0.407 -0.913',
      'IndexCMC_joint': '0.988 0.153 0.008',
      'IndexMCP_AA_joint': '-0.030 0.141 0.990',
      'IndexMCP_FE_joint': '0.988 0.153 0.008',
      'IndexPIP_joint': '0.988 0.153 0.008',
      'IndexDIP_joint': '0.988 0.153 0.008',
      'MiddleCMC_joint': '0.980 0.052 0.194',
      'MiddleMCP_AA_joint': '-0.198 0.082 0.977',
      'MiddleMCP_FE_joint': '0.980 0.052 0.194',
      'MiddlePIP_joint': '0.980 0.052 0.194',
      'MiddleDIP_joint': '0.980 0.052 0.194',
      'RingCMC_joint': '0.949 -0.070 0.309',
      'RingMCP_AA_joint': '-0.305 0.063 0.950',
      'RingMCP_FE_joint': '0.949 -0.070 0.309',
      'RingPIP_joint': '0.949 -0.070 0.309',
      'RingDIP_joint': '0.949 -0.070 0.309',
      'LittleCMC_joint': '0.898 -0.157 0.412',
      'LittleMCP_AA_joint': '-0.422 -0.037 0.906',
      'LittleMCP_FE_joint': '0.898 -0.157 0.412',
      'LittlePIP_joint': '0.898 -0.157 0.412',
      'LittleDIP_joint': '0.898 -0.157 0.412',
    }
